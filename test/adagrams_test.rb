...
describe 'Adagrams' do
  ...
  describe 'is in english dictionary' do
    
    it 'ignores case' do
      result = is_in_english_dict?("ZomBieLiKE")
      expect(result).must_equal true
    end
    
    it 'passes an english word' do
      result = is_in_english_dict?("zebra")
      expect(result).must_equal true
    end
    
    it 'passes plural words' do
      result = is_in_english_dict?("xylophones")
      expect(result).must_equal true
    end
    
    it 'does not pass a non-dictionary english word' do
      result = is_in_english_dict?("twerk")
      expect(result).must_equal false
    end
    
    it 'does not pass a non-english word' do
      result = is_in_english_dict?("arigato")
      expect(result).must_equal false
    end
    
    it 'does not pass an empty string' do
      result = is_in_english_dict?("")
      expect(result).must_equal false
    end
